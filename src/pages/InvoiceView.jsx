  ...
  return (
    <Modal open={!!inv} onClose={onClose} title="Tax Invoice" width="max-w-2xl">
      ...
      <table className="w-full text-xs mb-4">
        <thead><tr style={{ background: T.borderSoft }}>{["Item", "HSN", "Qty", "Rate", "Amount", totals.interState ? "IGST" : "CGST+SGST", "Total"].map((h) => <th key={h} className="text-left px-2 py-1.5 font-medium" style={{ color: T.inkSoft }}>{h}</th>)}</tr></thead>
